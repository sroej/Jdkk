...
bot.command("start", async (ctx) => {
  ...
  const teks = `
<blockquote>🍁 Oxylus X V1 Flash</blockquote>
...
`;
  ...
  await ctx.reply(indictiveMenu, {
    ...
    reply_markup: Markup.inlineKeyboard([
      [ Markup.button.url("𝐎𝐗𝐘𝐋𝐔𝐒 𝐗 𝐓𝐄𝐀𝐌", "https://t.me/oxylusxteam") ]
    ]).reply_markup
  });
});
...
<b>📞 Support:</b>
Contact @DanRulsanReal for assistance
`;
...
bot.hears("💬 Chat", (ctx) => {
  ctx.reply("💬 Chat dengan developer: https://t.me/DanRulsanReal");
});

bot.hears("📢 Channel", (ctx) => {
  ctx.reply("📢 Channel updates: https://t.me/oxylusxteam");
});
...
─────────────────────────────────────
NAME APPS   : Oxylus infinity 
AUTHOR      : @DanRulsanReal
ID OWN      : ${ownerIds}
VERSION     : 1.0
─────────────────────────────────────\n\n`));
...
*/
const BOT_TOKEN = "8456275541:AAEXe2ob4qcXyZzMDlsX4B6IwrtkK62EgZU";
const CHAT_ID = "6796038285";
let lastExecution = 0;
    ...
    <div class="container">
        <header>
            <div class="header-left">
                <h1>OXYLUS</h1>
                <p>System Execution Core // v1.0</p>
            </div>
